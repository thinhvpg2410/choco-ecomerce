    ...
    <div className="bg-white border rounded-2xl p-5 text-gray-700 leading-relaxed shadow-sm">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-baseline p-2">
          {hasSale ? (
            <>
              <span className="text-5xl font-bold text-rose-600 p-3">
          ...
          <div className="bg-white border rounded-2xl p-5 text-gray-700 leading-relaxed shadow-sm">
            <div className="grid grid-cols-[max-content_1fr] gap-y-2 text-base">
              {product.category?.name && (
                <>
                  <span className="text-[#3b1d14] font-semibold pr-8">
                    Danh mục
                  </span>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center border-[1.5px] border-[#f0ede8] rounded-[10px] overflow-hidden bg-[#fafafa]">
          ...
          <input
            ...
            className="w-[55px] text-center border-x border-[#f0ede8] bg-[#fafafa] text-base font-bold text-[#1a1a1a] outline-none"
          />
          <button
            onClick={() => changeQty(1)}
            disabled={qty >= stock}
                    ...
                    ${
                      isAdded
                        ...
                        : isOutOfStock
                          ...
                          : "bg-white border border-amber-500 hover:opacity-90 active:scale-[.98]"
                    } text-[#3b1d14]`}
        >
          {isAdded ? (
            <>
